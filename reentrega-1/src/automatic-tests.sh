...
./tp1 -o ./outputs-automatic-tests/uno.pgm -m mips32
echo "Se genero el archivo uno.pgm, para lo cual se especifico o."

./tp1 -c 0.282-0.007i -w 0.005 -H 0.005 -o ./outputs-automatic-tests/dos.pgm -m mips32
echo "Se genero el archivo dos.pgm, para lo cual se especifico c, w, H y o."

./tp1 -m mips32 -o ./outputs-automatic-tests/unoMips32.pgm -m mips32
